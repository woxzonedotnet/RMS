...
namespace RMS.Forms.Inventory
{
    public partial class frmPurchaseOrder : Form
    {
        ...
        private string SelectionFormularValues(int iReportID)
        {
            ...
            {
                srtFormular += "{" + oReportMaster.SelectedTable + ".fldPOCode}='" + this.txtPONumber.Text + "'"; // +"' AND {tbl_daily_in_out_details.fldAttendanceDate}=#" + Convert.ToDateTime(dFromDate).ToString("yyyy-MM-dd") + "# TO #" + Convert.ToDateTime(dToDate).ToString("yyyy-MM-dd") + "# ";
            }
